...
`, { inline: t2 }));
    ...
    return n3 ? n3.reduce(function(t3, n4) {
      ...
      if (-1 !== r2) {
        const a2 = function(e3) {
          return -1 !== e3.indexOf("-") && null === e3.match(B) && (e3 = e3.replace(N, function(e4, t4) {
  ...
  const q2 = [], Q2 = {}, V2 = { [r.blockQuote]: { match: Me(p), order: 1, parse(e2, t2, n3) {
    const [, r2, i3] = e2[0].replace(u, "").match(f);
