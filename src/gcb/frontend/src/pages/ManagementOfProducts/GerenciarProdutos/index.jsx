...
const GerenciarProdutos = () => {
    ...
    const removerItem = () => {
        ...
        const confirm_dialog = confirm("Deseja realmente remover esse produto dos registros?")
        if( !confirm_dialog ) {
            return
        }
        ...
        for (let linha = 0; linha < itensSelecionados.length; linha ++) {
            ...
            idDoProdutoAtual = linhaSelecionada.childNodes[1].innerText
    ...
    const alterarItem = () => {
        ...
        let id = itensSelecionados[0].childNodes[1].innerText;
        let produto = itensSelecionados[0].childNodes[2].innerText;
        let marca = itensSelecionados[0].childNodes[3].innerText;
        let quantidade = itensSelecionados[0].childNodes[4].innerText;
        navigate('/alterar-dados-produtos', {
            state: {
                id: id,
                produto: produto,
                marca: marca,
    ...
    const update_stock_itens = async () => {
