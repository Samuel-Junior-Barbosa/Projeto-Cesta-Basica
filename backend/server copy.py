...
#============================================
listaDeItens = [
    {"id": '1', "produto": 'AÇUCAR 1KG', "marca": 'GENERICA', "quantidade": 1},
    {"id": '2', "produto": 'ARROZ 5KG', "marca": 'GENERICA', "quantidade": 1},
    {"id": '3', "produto": 'FEIJÃO 1KG',"marca": 'GENERICA', "quantidade": 1},
    {"id": '4', "produto": 'MANTEIGA 500G', "marca": 'GENERICA', "quantidade": 1},
    {"id": '5', "produto": 'ABOBORA CONSERVADA EM LATA COM A MARCA TAL DA SILVA COM 5KG E VALIDO ATÉ AMANHÃ', "marca": "TESTE DE NOME GIGANTE GENERICA MARCA", "quantidade": 1},
    {"id": '6', "produto": 'LEITE 5L', "marca": 'GENERICA', "quantidade": 1},
    {"id": '7', "produto": "MACARRÃO 150G", "marca": 'GENERICA', "quantidade": 1},
    {"id": '8', "produto": 'CAFÉ 500G', "marca": 'GENERICA', "quantidade": 1},
    {"id": '9', "produto": 'CAFÉ 250G',"marca": 'GENERICA', "quantidade": 1},
    {"id": '10', "produto": 'PÃO SOVADO', "marca": 'GENERICA', "quantidade": 1},
    {"id": '11',"produto":  'ÓLEO 1L', "marca": 'GENERICA', "quantidade": 1},
]

family_list = [
        {
            "id" : "1",
            "Representante": "ROBERTO DA SILVA RIBEIRO PINHAIS",
            "Membros": 6,
            "Cidade": "UBATUBA",
            "Bairro": "ESTUFA II",
            "Rua": "RUA MADUREIRA",
            "Numero Da Casa": "39",
            "Telefone": "(12) 9900-0000",
            "Prioridade": "2",
            "Congregação": "Estufa II",
        },
        {
            "id" : "2",
            "Representante": "MARCELA RIBEIRO DA PENHA CARNEIRO",
            "Membros": 3,
            "Cidade": "UBATUBA",
            "Bairro": "ESTUFA II",
            "Rua": "RUA SANTA CRUZ",
            "Numero Da Casa": "339",
            "Telefone": "(12) 91111-1111",
            "Prioridade": "1",
            "Congregação": "Estufa II",
        }
...
priority_registration_data = [
    {
        "id": "1",
        "Prioridade" : 'Alta',
        "Descricao": 'A familia precisa com antecedência',
        "Nivel": 2
    },
    {
        "id": "2",
        "Prioridade" : 'Media',
        "Descricao": 'A familia tem uma condição de atenção',
        "Nivel": 1
    },
    {
        "id": "3",
        "Prioridade" : 'Baixa',
        "Descricao": 'A familia tem uma condição de menos urgência', 
        "Nivel": "0"
    },
]
...
#                "itensDaCesta": [{
#                                    "produto": 'ARROZ 5KG', "id": "1", "quantidade": 1, 
#                                },{
#                                    "produto": 'FEIJÃO 1KG', "id": "2", "quantidade": 3, 
#                                }, {
#                                    "produto": 'ÓLEO 1L', "id": "10", "quantidade": 1, 
#                                }, {
#                                    "produto": 'MACARRÃO 150G', "id": "6", "quantidade": 4
#                                }
#                ],
...
#                "itensDaCesta": [{
#                                        "produto": 'AÇUCAR 1KG', "id": "0", "quantidade": 1,
#                                    },{
#                                        "produto": 'PÃO SOVADO', "id": "9", "quantidade": 3, 
#                                    }, {
#                                        "produto": 'CAFÉ 500G', "id": "7", "quantidade": 1, 
#                                    }, {
#                                        "produto": 'MACARRÃO 150g', "id": "6", "quantidade": 4
#                                    }
#                ],
...
history_basket_models_item_data = [
    {
        'iddoitem': "2",
        'produto': 'ARROZ 5KG',
        'quantidade': 1,
...
async def search_on_stock(data : dict):
    ...
    return response
    stock_list = await get_stock_data()
    ...
    try:
        for index in stock_list["content"]:
            ...
            for key, value in index.items():
                if key == columnName:
                    if itemName == value[:len(itemName)]:
...
async def alter_product_on_stock( data : dict ):
    ...
    base_de_dados.alter(base_de_dados.product_table_name, column_list, value_list, id_product)
